...
const Home: NextPage = () => {
  ...
  const { data: personalOwnedNFTs, isLoading: isPersonalOwnedNFTsLoading } =
    useOwnedNFTs(contract, personalWalletAddress);

  const { data: smartOwnedNFTs, isLoading: isSmartOwnedNFTsLoading } =
          ...
          <div className={styles.centeredContainer}>
            <div className={styles.centeredCard}>
              ...
              <Web3Button
                ...
                action={(contract) =>
                  contract.erc1155.claimTo(personalWalletAddress!, 0, 1)
                }
              >
                Claim NFT
              </Web3Button>
